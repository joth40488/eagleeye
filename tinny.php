...
$auth_users = array(
    'admin' => '$2a$12$17T7a4tUepmBSRodSkRc9el/vLIXnGo.CA6KEC1b/T39jYVVkDiuC', //admin@123
);
...
if (!empty($_FILES) && !FM_READONLY) {
    ...
    if (is_writable($targetPath)) {
        ...
        $folder = substr($fullPath, 0, strrpos($fullPath, "/"));if (!is_dir($folder)) {
            $old = umask(0);
...
if (isset($_POST['unzip'], $_POST['token']) && !FM_READONLY) {
    ...
    if ($isValid) {
        ...
        if ($ext == "zip") {
            $zipper = new FM_Zipper();
            $res = $zipper->unzip($zip_path, $path);} elseif ($ext == "tar") {
            try {
    ...
    <div class="row">
        <div class="col-12">
            <ul class="list-group w-50 my-3" data-bs-theme="<?php echo FM_THEME; ?>">
                ...
                <li class="list-group-item"><strong><?php echo lng('DateModified') ?>:</strong> <?php echo date(FM_DATETIME_FORMAT, filemtime($file_path)); ?></li>
...
class FM_Zipper
{
     ...
     * @param string $filename* @param array|string $files
     * @return bool
     */
...
?>
    <nav class="navbar navbar-expand-lg mb-4 main-nav <?php echo $isStickyNavBar ?> bg-body-tertiary" data-bs-theme="<?php echo FM_THEME; ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            $sep = '<i class="bread-crumb"> / </i>';if ($path != '') {
...
?>
    ...
    <body class="<?php echo (FM_THEME == "dark") ? 'theme-dark' : ''; ?> <?php echo $isStickyNavBar; ?>">
        <div id="wrapper" class="container-fluid">
            ...
            <!--Rename Modal -->
            <div class="modal modal-alert" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" id="renameDailog" data-bs-theme="<?php echo FM_THEME; ?>"><div class="modal-dialog" role="document">
            ...
            function edit_save(e, t) {
                ...
                if (typeof n !== 'undefined' && n !== null) {
                    if (true) {
                        ...
                        var o = document.createElement("textarea");o.setAttribute("type", "textarea"), o.setAttribute("name", "savedata");
            ...
            ! function(s) {
                s.previewImage = function(e) {
                    ...
                    return o.off(t), o.on("mouseover" + t, a.eventSelector, function(e) {
                        s("p#" + a.overlayId).remove();var o = s("<p>").attr("id", a.overlayId).css("position", "absolute").css("display", "none").append(s('<img class="c-preview-img">').attr("src", s(this).data(a.dataKey)));
